...
model_id = "/data/project/model_weights/lyrics_gen/Qwen3-4B"
...
output = model.generate(input_ids=input_ids,attention_mask=attention_mask, max_length=300, logits_processor=[rhyme_processor],repetition_penalty=1.2)
